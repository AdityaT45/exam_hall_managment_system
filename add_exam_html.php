                    ...
                    <form method="post" action="add_exam.php">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="class" name="class" required>
                                ...
                                <!-- Fetch and display classes dynamically from database -->
                                <?php
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<option value='" . $row['class_id'] . "'>" . $row['name'] . "</option>"; // Changed 'id' to 'class_id'
                                    }
                                }
                                ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="subject" name="subject" required>
                                ...
                                <!-- Fetch and display subjects dynamically from database -->
                                <?php
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<option value='" . $row['subject_id'] . "'>" . $row['name'] . "</option>"; // Changed 'id' to 'subject_id'
                                    }
                                }
                                ?>
                            </select>
