                ...
                <div class="container mt-5">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT allotments.*, classes.name AS class_name, subjects.name AS subject_name, exams.exam_name AS exam_name, rooms.name AS room_name FROM allotments 
                        ...
                        INNER JOIN rooms ON allotments.room_id = rooms.room_id";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='5'>No allotments found</td></tr>";
                            }
