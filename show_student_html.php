                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>" . $row['role_number'] . "</td>";
                                        echo "<td>" . $row['name'] . "</td>";
                                        echo "<td>" . $row['email'] . "</td>";
                                        echo "<td>" . $row['phone'] . "</td>";
                                        echo "<td>";
                                        echo "<a href='update_student.php?id=" . $row['student_id'] . "' class='btn btn-primary btn-space'>Update</a>";
                                        echo "<a href='delete_student.php?id=" . $row['student_id'] . "' class='btn btn-danger'>Delete</a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                } else {
