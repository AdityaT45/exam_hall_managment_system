                ...
                <div class="container mt-5">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT exams.*, classes.name AS class_name, subjects.name AS subject_name FROM exams INNER JOIN classes ON exams.class_id = classes.class_id INNER JOIN subjects ON exams.subject_id = subjects.subject_id";
